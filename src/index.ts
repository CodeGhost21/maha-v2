...
import { updateLBCache, updateLBWithSortKeysCache } from "./cron/updateLBCache";
...
import "./strategies";
import buyNotifBot, { getMarketCap } from "./scripts/buyNotifBot";
...
cron.schedule("*/10 * * * *", async () => {
  ...
  await updateLBCache();
  await updateLBWithSortKeysCache();
  await totalUsers();
});
